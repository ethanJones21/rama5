...
const IntroPage = () => {
  ...
  useEffect(() => {
    if (firstViewPage) {
      // FIXME: descoment this line when the app is ready
      // history.push('/login');
    }
  }, [firstViewPage]);
        ...
        <div className="" style={{ width: '90%' }}>
          ...
          <div className="w-full flex items-center space-x-4 mt-24 mb-16 text-white text-11">
            ...
            <Link
              ...
              type="button"
              className="block w-full flex justify-center items-center rounded-16 py-7" // FIXME: w-1/2 (after descoment buttom below)
