...
import { postGroupInvitation, postGroupSilent, targetGroup } from '../store/app/groupUserSlice';
...
const ChatMessage = ({
  ...
  const handleRedirectPrivate = (item) => {
    dispatch(targetGroup(item));
  ...
  return (
    ...
    >
      <div className="flex flex-col space-y-9">
        {DataChat?.map((item) => (
          <div
            onClick={() => redirectPrivate && handleRedirectPrivate(item)}
